#!/usr/bin/env python3
"""
Test Suite for Judge Protocol

Tests the functionality of: scripts/ops/judge.py
"""
import unittest
import sys
import os
...
class TestJudgeProtocol(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.script_path = cls.project_root / "scripts/ops/judge.py"
    ...
    def test_dry_run_mode(self):
        ...
        result = subprocess.run(
            ["python3", str(self.script_path), "Build a custom framework from scratch", "--dry-run"],
            capture_output=True,
            text=True,
    ...
    def test_missing_api_key_handling(self):
        ...
        result = subprocess.run(
            ["python3", str(self.script_path), "Build a custom framework from scratch"],
            capture_output=True,
            text=True,
            cwd=self.project_root,
            env=env,
