#!/usr/bin/env python3
"""
Test Suite for Probe Protocol

Tests the functionality of: scripts/ops/probe.py
"""
import unittest
import sys
import os
...
class TestProbeProtocol(unittest.TestCase):
    """Tests for Probe Protocol"""

    @classmethod
    def setUpClass(cls):
        """Set up test fixtures"""
        cls.project_root = PROJECT_ROOT
        cls.script_path = cls.project_root / "scripts/ops/probe.py"
    ...
    def test_dry_run_mode(self):
        ...
        result = subprocess.run(
            ["python3", str(self.script_path), "os.path", "--dry-run"],
            capture_output=True,
            text=True,
    ...
    def test_basic_functionality(self):
        ...
        result = subprocess.run(
            ["python3", str(self.script_path), "os.path", "--show-dunder"],
            capture_output=True,
            text=True,
            cwd=self.project_root,
            timeout=30
