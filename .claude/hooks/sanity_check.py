...
code_intent = ["write a script", "create a tool", "implement", "code", "build", "add a function"]
risky_libs = ["pandas", "numpy", "aws", "boto3", "azure", "openai", "anthropic", "requests", "django", "flask", "fastapi", "sqlalchemy", "pydantic", "tensorflow", "pytorch", "sklearn"]
