...
def cmd_start(args):
    ...
    # Launch Chrome
    width = getattr(args, 'width', 1920) or 1920
    height = getattr(args, 'height', 1080) or 1080
    chrome_args = [
        chrome,
...
def main():
    ...
    p_start.add_argument("--width", type=int, default=1920, help="Viewport width (default: 1920)")
    p_start.add_argument("--height", type=int, default=1080, help="Viewport height (default: 1080)")
