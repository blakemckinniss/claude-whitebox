...
Usage Examples:
    ...
    python3 scripts/ops/detour.py status

    # Resolve most recent detour
    python3 scripts/ops/detour.py resolve

    # Resolve specific detour by ID
    python3 scripts/ops/detour.py resolve abc123

    # Abandon a detour
    python3 scripts/ops/detour.py abandon abc123 "Will fix in next sprint"

    # Peek at current detour without resolving
    python3 scripts/ops/detour.py peek

    # Test detour detection on sample errors
    python3 scripts/ops/detour.py test

    # Clear detour state
    python3 scripts/ops/detour.py clear
"""
import sys
import os
...
def action_clear():
    ...
    print(f"About to clear detour stack:")
